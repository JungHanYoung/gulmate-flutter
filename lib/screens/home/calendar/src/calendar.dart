...
class _TableCalendarState extends State<TableCalendar> with SingleTickerProviderStateMixin {
  ...
  Widget _buildHeader() {
    final children = <Widget>[
      Text("일정", style: TextStyle(color: Color.fromRGBO(255, 109, 0, 1), fontSize: 30),),
      Text("${widget.calendarController.focusedDay.month}월", style: TextStyle(color: Color.fromRGBO(153, 153, 153, 1), fontSize: 16.0),),
//      _CustomIconButton(
...
//      ),
    ...
    if (widget.headerStyle.formatButtonVisible && widget.availableCalendarFormats.length > 1) {
      children.insert(1, const SizedBox(width: 8.0));
      children.insert(2, _buildFormatButton());
    }
