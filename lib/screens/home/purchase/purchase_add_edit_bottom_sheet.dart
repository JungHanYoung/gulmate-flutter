...
class PurchaseAddEditBottomSheet extends StatefulWidget {
  @override
  _PurchaseAddEditBottomSheetState createState() => _PurchaseAddEditBottomSheetState();
}

class _PurchaseAddEditBottomSheetState extends State<PurchaseAddEditBottomSheet> {
